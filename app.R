...
ui <- navbarPage("Info 201 Final Project",
  tabPanel("Introduction",
           ...
           em(strong(p("How do different factors affect life expectancy between two comparing countries?")))),
  tabPanel("Page 1",
           h1("Life Expectancy Worldwide by Year"),
           img(src="https://cdn.discordapp.com/attachments/904791430768263248/918000513356808192/image.axd.webp",
               width="50%", height="50%", align="right"),
           sliderInput("expectancy_year", label="Select year", min=2000, max=2015, value=2015, 
                       sep="", ticks=F), 
           plotOutput("worldplot")),
  tabPanel("Page 2",
           sliderInput("causes_year", label="Select year", min=1999, max=2017, value=2017, 
                       sep="", ticks=F),
           tableOutput("death_causes")),
  tabPanel("Page 3",
           selectInput(inputId="country1", label="First country:", 
